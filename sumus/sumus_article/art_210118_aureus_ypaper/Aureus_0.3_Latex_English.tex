...
Why and for what are we creating the Aureus Securities AG blockchain? The existing blockchains, with all their attractiveness in terms of security and anonymity, have many drawbacks for practical use:
\begin{itemize}
...
The blockchain Aureus Securities AG was created with the aim of preserving the important properties of the blockchain and eliminating its weaknesses.
...
\begin{itemize}
	\item be confident in the safety of their valuables;
	\item transfer value freely, quickly, reliably and without commissions anywhere in the world.

\end{itemize}

\section{Platform Description}
The financial platform of Aureus Securities AG is based on the technologies of the Gaus \footnote{The description of all the capabilities of the Gaus blockchain constructor is not the purpose of this document.}.
The project-dependent part of the blockchain was developed in collaboration with Gaus specialists. Key features of the Aureus Securities AG blockchain network
\begin{itemize}
...
The objectives of the Aureus Securities AG blockchain application demanded a consensus that met the following parameters.
\begin{enumerate}
...
\subsection{Free international payments}

The cryptocurrency market has grown in large part due to the demand for free, fast and inexpensive international payments. This is especially true in China, where the circulation of currencies is highly restricted by the state. \\

According to the analysis of the participants of the Money 20/20 conference in Singapore, no
payment system allows conducting cross-border transactions of more than 5,000 USD. The only
tool for transferring more than 5,000 - 10,000 USD between states is SWIFT. But to make a
transfer, you will need to fill out a lot of documents, wait for the bank to check the documents,
discuss the transfer with the currency control manager, and then wait several hours for the
transfer to be completed. SWIFT cost is about 1\%.\\

Aureus Securities AG allows you to transfer any amount free of charge anywhere in the world in a few seconds without talking to bank managers.

To get Aureus Securities AG blockchain tokens, you need to contact the office at. To receive money instead of tokens, you will need to go through KYC authorization and after that the money will be sent to the provided bank details. 
